...
$(document).ready(function(){
	$(".like").click(function(){
		...
		$.post("addlike.php?pid="+getid,{},
		function(data){
			
			$("#like"+getid).html(data);
	...
	$(".dislike").click(function(){
		...
		$.post("removelike.php?pid="+getid,{},
		function(data){
		
			$("#dislike"+getid).html(data);
	});
	});
...
<div id="link">  
 ...
 <li><a href ="logout.php"> Logout </a> </li>
   <li><a href ="viewidea.php?page=1"> View Ideas </a> </li>
		...
		<a href="newidea.php">Back</a><br/><br/>
...
<?php
	...
	?>
				...
				<a href="addcomment.php" class="comment" id="<?php echo($row2['i_id']); ?>">Comment</a>
